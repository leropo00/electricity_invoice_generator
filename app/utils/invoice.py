...
__all__ = ["calculate_measurements_total_usage", "calculate_measurements_time_block_usage"]

def calculate_measurements_total_usage(session: Session, year: int, month: int, customer_id: int):
...
def calculate_measurements_time_block_usage(session: Session, year: int, month: int, customer_id: int):     
    ...
    for time_block in possible_time_blocks:           
        ...
        if time_block in workday_blocks_with_hours:
            price, consumption = _calculate_time_block(session, start_date, end_date, customer_id, workday_blocks_with_hours[time_block], SeasonDayType.WORKDAY)
            price_sum += price
            consumption_sum += consumption

        if time_block in offday_blocks_with_hours:
            price, consumption = _calculate_time_block(session, start_date, end_date, customer_id, offday_blocks_with_hours[time_block], SeasonDayType.OFFDAY)
            price_sum += price
            consumption_sum += consumption
...
def _calculate_time_block(session: Session, start_date: date, end_date: date, customer_id: int, hours:list, day_type: SeasonDayType):
